...
$('.li-level-pengguna').addClass('active');
...
$(document).ready(function(){
	...
	table = $('#dataTable').DataTable({
        ...
        'ajax' : {
        	'url'	: baseurl + 'level-pengguna/datatable/',
            'type'	: 'GET',
...
$('#dataTable').on('click', 'button[name="btn_edit"]', function(){
    ...
    $.ajax({
        type: 'GET',
        url: baseurl + 'level-pengguna/edit/'+ id +'/',
        dataType: 'json',
        success: function(response){
            if(response.result){
                var d = response.data;
...
$('#dataTable').on('click', 'button[name="btn_delete"]', function(){
	...
	$.ajax({
        type: 'POST',
        url: baseurl + 'level-pengguna/delete/',
        data: {
        	'id': id,
...
$('button[name="btn_save"]').click(function(){
    ...
    $.ajax({
        type: 'POST',
        url: baseurl + 'level-pengguna/save/',
        data: {
        	'id': $(this).attr('id'),
