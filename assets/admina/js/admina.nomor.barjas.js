...
$('.li-nomor-barjas').addClass('active');
...
$(document).ready(function(){
	...
	table = $('#dataTable').DataTable({
        ...
        'ajax' : {
        	'url'	: baseurl + 'nomor-barjas/datatable/',
            'type'	: 'GET',
            'data'  : function(d){
    ...
    $.ajax({
        type: 'GET',
        url: baseurl + 'nomor-barjas/select-bagian/',
        dataType: 'json',
        success: function(response){
            if(response.result){
...
$('#dataTable').on('click', 'button[name="btn_edit"]', function(){
    ...
    $.ajax({
        type: 'GET',
        url: baseurl + 'nomor-barjas/edit/'+ id +'/',
        dataType: 'json',
        success: function(response){
            if(response.result){
                var d = response.data;
...
$('#dataTable').on('click', 'button[name="btn_delete"]', function(){
	...
	$.ajax({
        type: 'POST',
        url: baseurl + 'nomor-barjas/delete/',
        data: {
        	'id': id,
...
$('input[name="upload_file"]').on('change', function(){
    if ($(this).val() != '') {
        ...
        $.ajax({
            type: 'POST',
            url: baseurl + 'nomor-barjas/upload/',
            data: fu,
            dataType: 'json',
            contentType: false,
            processData: false,
