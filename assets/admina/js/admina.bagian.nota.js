...
$('.li-bagian-nota').addClass('active');
...
$(document).ready(function(){
	...
	table = $('#dataTable').DataTable({
        ...
        'ajax' : {
        	'url'	: baseurl + 'bagian-nota/datatable/',
            'type'	: 'GET',
...
$('#dataTable').on('click', 'button[name="btn_edit"]', function(){
    ...
    $.ajax({
        type: 'GET',
        url: baseurl + 'bagian-nota/edit/'+ id +'/',
        dataType: 'json',
        success: function(response){
            if(response.result){
                var d = response.data;
...
$('#dataTable').on('click', 'button[name="btn_delete"]', function(){
	...
	$.ajax({
        type: 'POST',
        url: baseurl + 'bagian-nota/delete/',
        data: {
        	'id': id,
