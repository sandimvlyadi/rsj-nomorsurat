...
$(document).ready(function(){
	...
	table = $('#dataTable').DataTable({
        ...
        'ajax' : {
        	'url'	: baseurl + 'pengguna/datatable/',
            'type'	: 'GET',
            'dataSrc' : function(response){
            	...
            	if (response.result) {
            		for(var x in response.data){
                        var button = '';
                        if (response.data[x].id_level_pengguna == 1) {
