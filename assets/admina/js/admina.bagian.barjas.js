...
$('.li-bagian-barjas').addClass('active');
...
$(document).ready(function(){
	...
	table = $('#dataTable').DataTable({
        ...
        'ajax' : {
        	'url'	: baseurl + 'bagian-barjas/datatable/',
            'type'	: 'GET',
...
$('#dataTable').on('click', 'button[name="btn_edit"]', function(){
    ...
    $.ajax({
        type: 'GET',
        url: baseurl + 'bagian-barjas/edit/'+ id +'/',
        dataType: 'json',
        success: function(response){
            if(response.result){
                var d = response.data;
...
$('#dataTable').on('click', 'button[name="btn_delete"]', function(){
	...
	$.ajax({
        type: 'POST',
        url: baseurl + 'bagian-barjas/delete/',
        data: {
        	'id': id,
...
$('button[name="btn_save"]').click(function(){
    ...
    $.ajax({
        type: 'POST',
        url: baseurl + 'bagian-barjas/save/',
        data: {
        	'id': $(this).attr('id'),
