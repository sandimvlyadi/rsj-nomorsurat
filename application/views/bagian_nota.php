...
<head>
  ...
  <title>Sistem Penomoran Surat | Bagian Nota Dinas</title>
            ...
            <div class="box-body">
              <div class="row" style="padding-bottom: 10px;">
                <div class="col-xs-6">
                  ...
                  <input id="3" type="file" name="upload_import" accept=".csv" style="display: none;">
                </div>
                <div class="col-xs-6">
...
<script src="<?php echo base_url('assets/admina/js/admina.bagian.nota.js'); ?>"></script>
</body>
</html>