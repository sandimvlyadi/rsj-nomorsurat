...
class Level_pengguna extends CI_Controller {
	...
	public function __construct()
	{
		...
		$this->load->model('level_pengguna_model', 'model');
		...
		$role = $this->login->role($this->userData, 'level_pengguna');
		if(!$role['result']){
			redirect('dashboard/');
		}
	}
