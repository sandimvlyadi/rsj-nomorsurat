...
class Nomor_barjas extends CI_Controller {
	...
	public function __construct()
	{
		...
		$this->load->model('nomor_barjas_model', 'model');
		...
		$role = $this->login->role($this->userData, 'nomor_barjas');
		if(!$role['result']){
			redirect('dashboard/');
		}
	}
