...
class Bagian_barjas extends CI_Controller {
	...
	public function __construct()
	{
		...
		$this->load->model('bagian_barjas_model', 'model');
		...
		$role = $this->login->role($this->userData, 'bagian_barjas');
		if(!$role['result']){
			redirect('dashboard/');
		}
	}
