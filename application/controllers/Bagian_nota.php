...
class Bagian_nota extends CI_Controller {
	...
	public function __construct()
	{
		...
		$this->load->model('bagian_nota_model', 'model');
		...
		$role = $this->login->role($this->userData, 'bagian_nota');
		if(!$role['result']){
			redirect('dashboard/');
		}
	}
